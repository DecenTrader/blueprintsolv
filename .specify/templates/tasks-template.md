...
**Tests**: The examples below include test tasks. Tests are MANDATORY per the project constitution (Principle I: Test-First Development). Tests MUST be written before implementation and confirmed to fail (Red) before any implementation code is produced.
